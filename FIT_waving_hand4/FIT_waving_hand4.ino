...
const byte SERVO_SLEW_RATE = 80; //deg/sec 
...
//-note: for this function to work properly, the expectation is that you must actually command 
// the slewedCommand to the servo after calculating it /////////////////
//---------------------------------------------------------------------------------------
byte slewServo(const byte SERVO_INDEX, byte newCommand, byte oldCommand, byte servoSlewRate, bool startOver = false)
{
  static byte slewedCommand = oldCommand; //deg
